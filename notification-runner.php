...
class Notification_Runner_Plugin {
  function __construct() {
    add_filter( 'auto_plugin_update_send_email', '__return_false' );

    add_filter( 'auto_theme_update_send_email', '__return_false' );
    
    add_filter( 'auto_core_update_send_email', array( $this, 'irunstuff_stop_auto_update_emails' ), 10, 4 );
  }

  function irunstuff_stop_auto_update_emails( $send, $type, $core_update, $result ) {
...
$notification_runner_plugin = new Notification_Runner_Plugin();
